...
export default function ReactHookFromExample() {
  return (
    <main className="min-h-screen bg-[#F3F0DE] p-8 font-sans">
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-150 text-xs">
          <h2 className="font-bold text-sm text-green-950 mb-2">React Hook Form basic</h2>
          <p className="text-gray-500">Demonstrates basic react-hook-form bindings without validation libraries.</p>
        </div>
      </div>
    </main>
  );
